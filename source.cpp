...
void introScreen()
{
	...
	glColor3f(0, 1, 0);
	renderBitmapString(-80, 265, GLUT_BITMAP_TIMES_ROMAN_24, "THAPAR UNIVERSITY");
	glColor3f(1, 0.5, 0);
	renderBitmapString(-70, 230, GLUT_BITMAP_TIMES_ROMAN_24, "STUDENTS OF CS10");
	glColor3f(1, 0.5, 0);
	glColor3f(1, 1, 0);
	renderBitmapString(-70, 90, GLUT_BITMAP_TIMES_ROMAN_24, "FLAPPY BIRD GAME");
	glColor3f(1, 0.5, 0);
	renderBitmapString(-290, -30, GLUT_BITMAP_TIMES_ROMAN_24, "BY:");
	glColor3f(1, 1, 1);
	renderBitmapString(-260, -60, GLUT_BITMAP_TIMES_ROMAN_24, "GOVIND SINGLA         (102016060)");
	renderBitmapString(-260, -90, GLUT_BITMAP_TIMES_ROMAN_24, "RHYTHM     (10206092)");
	glColor3f(1, 0.5, 0);/*
